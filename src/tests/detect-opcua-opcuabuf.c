...
static int DetectOPCUAopcuabufTest(void)
{
    ...
    AppLayerParserParse(NULL, alp_tctx, &f, ALPROTO_OPCUA,
...
{
    UtRegisterTest("DetectOPCUAopcuabufTest", DetectOPCUAopcuabufTest);
}
